...
public class LightWeightAdminLoginServlet extends HttpServlet {
    @Override
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                ...
                synchronized (this) {
                    if (userManager.isAdminConnected()) {
                        String errorMessage = "Admin already connected. Please try again later.";

                        // stands for unauthorized as there is already such user with this name
                        response.setStatus(HttpServletResponse.SC_UNAUTHORIZED);
                        response.getOutputStream().print(errorMessage);
                    } else if (userManager.isClientExists(usernameFromParameter)) {
                        ...
                        userManager.addClient(usernameFromParameter, true);
